...
export default function LandingPage() {
  ...
  return (
    <div className="landing-page">
      ...
      <header className="landing-header">
        ...
        {menuOpen && (
          <div className="mobile-menu">
            ...
            <a href="#upcoming" className="nav-link" onClick={closeMenu}>Upcoming</a>
            <a href="#contact" className="nav-link" onClick={closeMenu}>Contact</a>
            <div className="mobile-menu-actions">
              <button className="btn btn-ghost" onClick={() => { closeMenu(); navigate('/signin'); }}>
                Sign In
              </button>
              <button className="btn btn-primary" onClick={() => { closeMenu(); navigate('/signup'); }}>
                Get Started
              </button>
            </div>
          </div>
      ...
      <section id="features" className="features-section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">Tools designed to help you track, plan, and grow your wealth.</p>
          </div>
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>Clear charts show exactly where your money goes. Identify spending patterns and optimize.</p>
            </div>
      ...
      {/* Upcoming Features */}
      <section id="upcoming" className="features-section">
        <div className="container">
          <div className="section-header">
